...
<div id="wrap">
	<section>
		<article>
			<div class="container">
				<br>
				<h4 class="text-body">기업 통계</h4>
				<br>
				<div class="row rangebox">
					<div class="col-lg-7 col-md-7">
					<ul class="nav nav-tabs">
					  <li class="nav-item">
					    <a class="nav-link" href="starters?cmd=MemberStatistic">튜티&튜터</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link active" href="starters?cmd=companyStatistic">기업</a>
					  </li>
					</ul>
				...
				<div class="dropenroll col-lg-2 col-md-2">
					<div class="AllListSelect">
						<select class="AllListSelectt form-control form-control-sm" onchange="day(this.selectedIndex);">
							<option value="0" onclick="t(this)" selected="selected" >분기별</option>
							<option value="1" onclick="t(this)">연도별</option>
			...
			<%@include file="CompanyYearStatistics.jsp"%>
			</div>
		</div>
  ...
  <script type="text/javascript">
  	...
  	function day(selectedguy) {
 		...
 		console.log("selectedguy"+selectedguy);
  		...
  		$.ajax({
  			url : "starters?cmd=selectCompanyStatistic&select=" + selectBox,
