...
<title>스타터스 관리자 : QnA</title>
<%@include file="../../nav2.jsp"%>
<link rel="stylesheet" href="assets/css/admin/qna/qna_List.css" />

<div id="wrap">
<section>
<article>
<div class="container allB">
<form method="post" action="starters?cmd=adminQnaSearchAction">
<div class="container searchbox">
<br>
<h4>QnA</h4>
<br>
	<div class="form-row searchbox">
			<input type="text" class="form-control form-control-sm col-6 col-md-10 col-sm-6" id="txtsearch" name = "searchName" placeholder = "작성자를 입력해주세요.">
...
<script type="text/javascript">
	var qnaWrite = function(){
		location.href = "starters?cmd=adminQnaRegister";
	};
