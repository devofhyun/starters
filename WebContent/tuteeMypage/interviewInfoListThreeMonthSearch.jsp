...
<form action="" method="post">
	<div class="container content">
		<div class="board">
			<p>${interviewThreeMonthCount}개의 면접요청</p>
			...
			<c:forEach items="${interviewThreeMontList}" var="interviewList">
			    <tbody> 
			    	<tr>
...
<div class="paging">
<!-- pagination -->
<c:if test="${ interviewThreeMonthCount > 0}">
...
<script>
	...
	function p(jumpBtn) {
		...
		$.ajax({
			url : "starters?cmd=interviewInfoListThreeMonthSearchPaging&pageNum=" + rStr,
