...
<form action="" method="post">
	<div class="container content">
		<div class="board">
			...
			<c:forEach items="${interviewDateList}" var="interviewList">
			    <tbody> 
			    	<tr>
				        ...
				        <td>
				      	<a class="interviewMoreInfo" href="starters?cmd=interviewMoreInfo&num=${interviewList.interviewId}" >
...
<script>
	...
	function p(jumpBtn) {
		...
		$.ajax({
			url : "starters?cmd=interviewDateSelectPaging&pageNum=" + rStr,
