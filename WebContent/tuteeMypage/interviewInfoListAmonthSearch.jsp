...
<form action="" method="post">
	<div class="container content">
		<div class="board">
			<p>${interviewAMonthCount}개의 면접요청</p>
			...
			<c:forEach items="${interviewAmontList}" var="interviewList">
			    <tbody> 
			    	<tr>
...
<div class="paging">
<!-- pagination -->
<c:if test="${ interviewAMonthCount > 0}">
...
<script>
	...
	function p(jumpBtn) {
		...
		$.ajax({
			url : "starters?cmd=interviewInfoListAmonthSearchPaging&pageNum=" + rStr,
