...
<br>
	...
	<div class="container interviewMain">
		<jsp:include page="interviewInfoList.jsp" />
	</div>
...
$(window).resize(function (){
	...
	$('#aMonth').click(function() {
		var rRrt = $.ajax({
			url : "starters?cmd=interviewInfoListAmonth",
	...
	$('#threeMonth').click(function() {
		var rRrt = $.ajax({
			url : "starters?cmd=interviewInfoListThreeMonth",
			success : function(result) {
				$("div.interviewMain").html(result);
			}
		});
	...
	$('#sixMonth').click(function() {
		var rRrt = $.ajax({
			url : "starters?cmd=interviewInfoListSixMonth",
			success : function(result) {
				$("div.interviewMain").html(result);
			}
		});
	...
	$('#all').click(function() {
		var rRrt = $.ajax({
			url : "starters?cmd=interviewListAll",
			success : function(result) {
				$("div.interviewMain").html(result);
			}
		});
	...
	$('#find').click(function() { 
		...
		if ( from == "" && to == "" ) {
			...
			$.ajax({
				url : "starters?cmd=interviewDateSelectAction&date="+from+to,
				success : function(result) {
					$("div.interviewMain").html(result);
				}
			});
