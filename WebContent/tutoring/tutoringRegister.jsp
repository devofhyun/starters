...
<div class="container info">
	<div class="row ">
		...
		<div class="col-md-12 col-sm-12 col-lg-6 con">
			...
			<!-- 메인 타이틀-->
			<div class="mainTitleClass row form-inline ">
				<h6>타이틀</h6>
				<input type="text" name="mainTitle"
				class="form-control form-control-sm col-6">
			</div>
			<!-- 서브 타이틀-->
			<div class="subTitleClass row form-inline ">
				<h6>서브타이틀</h6>
			...
			<div class="row">
				...
				<div class="career form-inline">
					<h6>경력</h6>
					<input type="text" name="jobCareer" class="form-control form-control-sm col-6"/>년
				</div>
			 ...
			 <select name="mainSelect" id="mainSelect" class="mainSelect" multiple="multiple">
				...
				<div class="row form-inline" id="sample1">
					<div class="form-inline inputTime">
						...
						<p>
							<input id = "s1Time1" name="s1Time1" value=""  class="form-control form-control-sm col-3"/>
							 ~ <input id = "s1Time2" name="s1Time2" value=""  class="form-control form-control-sm col-3"/>
						</p>
					</div>
				...
				<div class="money form-inline">
					<h6> 금액</h6>
					<input type="text" name="tutoringMoney" class="form-control form-control-sm col-4"/>원
				</div>
			</div>
		</div>
	</div>
...
<button class="btn btn-outline-secondary list registerTutoring registerTutoringDay" id="btnSubmit" onclick="inputCheck(event);">등록하기</button>
</div>
...
$('#upload').loadImg({
	...
	var html = '<div class="form-inline inputTime"> <h6>강의 시간'
				...
				+ '"  name="s1Time'
				+ ((2 * count) + 1)
				+ '" class="form-control form-control-sm col-3" value="" /> ~ <input id = "s1Time'
				+ ((2 * count) + 2)
				+ '"name="s1Time'
				+ ((2 * count) + 2)
				+ '" class="form-control form-control-sm col-3" value="" /> </p>'
	...
	$(document)
			.ready(
					function() {
						$('ul.select > li').click(
								function() {
									$('ul.select > li.off').click(
											function() {
												$(this).siblings().addClass(
														'off').end().addClass(
														'on');
											});
									$('ul.select > li.on').click(
											function() {
												$(this).removeClass('on')
														.addClass('off').end()
														.addClass('on');
						...
						/* 0920추가 */
						/*					$('.registerTutoringDay').click(function() {
